<template>
    <div id="Content">
        <el-dialog id="hello" title="肿瘤辅助诊断系统使用须知" :visible.sync="centerDialogVisible" width="65%"
                ...
                <el-card style="border-radius: 8px;">
                    ...
                    <el-tabs v-model="activeName" @tab-click="handleClick">
                        ...
                        <el-tab-pane label="面积对比" name="second" style="width:750px;height:390px;">
                            <div id="areaCompare">
                                <el-table :data="feature_list" height="390" border
                                    style="width:750px;text-align:center;" v-loading="loading"
                                    element-loading-text="数据正在处理中，请耐心等待" element-loading-spinner="el-icon-loading">
                                    <el-table-column label="Feature" width="250px">
                                        <template slot-scope="scope">
                                            <span>{{scope.row[2]}}</span>
                                        </template>
